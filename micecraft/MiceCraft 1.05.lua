...
function addData(n)
data[n]={Object={dirt=50,TNT=50,Torch=true,Pickaxe=true},si=1,hearth={p=6,t=0}}
end

function n_item(n,type)
if type == 1 then
return "<p align='center'><font size='8'><br><b> "..data[n].Object.dirt.."</b></font>"
elseif  type == 3 then
return "<p align='center'><font size='8'><br><b> "..data[n].Object.TNT.."</b></font>"
else
return ""
end
end
...
x=200
for i=1,8 do
ui.addTextArea(i,"", n, x, 364, 35, 35, 0x545454, 0x8B8C7E, 0.5, true)---"<v>"..n_item(n,i)
ui.addTextArea(i+100, "test", n, x, 359, 35, 20, 0x545454, 0x8B8C7E, 0.5, true,false)
x=x+44
end
...
function eventLoop (m,j)
    for i=1,#ObjectsPhy do
		...
		if O.time == 0 and O.namep ~= "" then
		    if O.type == "dirt" then
			    if data[O.namep].Object.dirt < 64 then
			...
			elseif O.type == "TNT" then
			    if O.typei == 1 then
			        ...
			        if data[O.namep].Object.TNT < 34 then
			   	...
			   	elseif O.typei == 2 then
			        if data[O.namep].Object.TNT < 64 then
			            data[O.namep].Object.TNT=data[O.namep].Object.TNT+1
			    	end
	                SelectItem(O.namep,data[O.namep].si)
		            DP(21,O.x,O.y)
...
function open_shop(n,id)
    if id == 1 then
        tu.create.shop(1,1,"", "","","",n,250,80,true,true) 
	elseif id == 2 then
        tu.create.shop(1,2,"", "","","",n,250,80,true,true) 
	elseif id == 3 then
        tu.create.shop(1,3,"", "","","",n,250,80,true,true) 
	end
end
...
tu = {
    create = {
        p = {},
            ...
            ui.addTextArea(9 ..id.. 40 .. 200,""..(s == 1 and "" or "<a href='event:shop_Tapic_1'>").."<p align='center'>Blocks",n,x+3,y-(s == 1 and 27 or 22),50,50,(s == 1 and 6776420 or 9144451),3684665,1,true)
            ui.addTextArea(9 ..id.. 40 .. 201,""..(s == 2 and "" or "<a href='event:shop_Tapic_2'>").."<p align='center'>Pickaxes",n,x+61,y-(s == 2 and 27 or 22),50,50,(s == 2 and 6776420 or 9144451),3684665,1,true)
            ui.addTextArea(9 ..id.. 40 .. 202,""..(s == 3 and "" or "<a href='event:shop_Tapic_3'>").."<p align='center'>Torchs",n,x+119,y-(s == 3 and 27 or 22),50,50,(s == 3 and 6776420 or 9144451),3684665,1,true)
            ui.addTextArea(9 ..id.. 40 .. 203,"           <a href='event:shopClose_".. 9 ..id.. 40 .."'>X</a>",n,x+279,y+11,50,20,9144451,3684665,1,true)
            ui.addTextArea(9 ..id.. 40 .. 204,"",n,x,y,300,250,9144451,3684665,1,true)
