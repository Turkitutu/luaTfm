...
function mapS(n)
	...
	for i=1,#mapsO[n] do
		table.insert(ObjectsPhy,{x=mapsO[n][i].x,y=mapsO[n][i].y,i=id_ob,player="",type="Grass",typei=nil,time=0,bl=false,namep=""})
		tfm.exec.addPhysicObject(id_ob,mapsO[n][i].x,mapsO[n][i].y,{type=6, height=wh_Object, width=wh_Object, angle=0, friction=8, restitution=0, dynamic=false,foreground=true,color="0xE61414",miceCollision=true})
		id_ob=id_ob+1
	end
end
