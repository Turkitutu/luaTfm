...
function addData(n)
	data[n]={Object={["Grass"]=0,["dirt"]=20,["TNT"]=5,["pickaxe_1"]=15,PickaxeBl_1=true,PickaxeNum1=0,["torch"]=0,TorchBl=true},pieces={[1]=5,[2]=5,[3]=0},si="Grass",key=1,AMR=nil,hearth={p=6,t=0},mouse={x=6,y=0},shop={CanP=true,page=1}}
...
table.insert(bag_P,{i=pid,x=x,y=y,n=n,items={["Grass"]=db["Grass"],["dirt"]=db["dirt"],["TNT"]=db["TNT"],["pickaxe_1"]=db["pickaxe_1"]}})

if testing then add(pid+10000000000,"bag",nil,x,y,20,20,-1,1,1,false,false) end
